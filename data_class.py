...
class MNISTDataModule(pl.LightningDataModule):
    ...
    def prepare_data(self):
        ...
        # Download the Fashion-MNIST dataset
        fashion_mnist_train_val = torchvision.datasets.MNIST(root='../datasets', train=True,
                                                                         download=True, transform=transform)

        self.fashion_mnist_test = torchvision.datasets.MNIST(root='../datasets', train=False,
                                                                    download=True, transform=transform)
